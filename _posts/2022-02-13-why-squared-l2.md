...
The derivative of it depends on the entire vector, like this:
$$\frac{d}{dx_i}L^2(x) = \frac{1}{2}(x_1^2+x_2^2+...+x_i^2+...+x_n^2)^\frac{1}{2}^-1\cdot2x_i = (x_1^2+x_2^2+...+x_i^2+...+x_n^2)^\frac{1}{2}^-1\cdotx_i.$$
