...
So I have a messy reality of living and changing faces $$x$$, and I also  possibly have an inaccessible latent space of faces $$z$$. Something, say $$A$$ connects these two in "normal" conditions. Maybe a bit noise, a $$v$$ is added to the mix, which makes the whole situation to be expressible like so: 
